...
BCCD_Path = "C:/Users/wbchoi/PycharmProjects/wbchoi/PyTorch-YOLOv3/data/JPEGImages"
Out_Path = "C:/Users/wbchoi/PycharmProjects/wbchoi/PyTorch-YOLOv3/"
...
if __name__ == "__main__":
    ...
    for line in trainval:
        fout.write("data/custom/images/" + line + ".jpg" + "\n")
    fout.close()
    fout = open(os.path.join(output_dir, "train.txt"), 'w')
    for line in train:
        fout.write("data/custom/images/" + line + ".jpg" + "\n")
    fout.close()
    fout = open(os.path.join(output_dir, "valid.txt"), 'w')
    for line in val:
        fout.write("data/custom/images/" + line + ".jpg" + "\n")
    fout.close()
